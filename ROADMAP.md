...
| Tool Rendering | Done | 22 tool-specific views (incl. Codex MCP prompt view), KnownTools registry (30+ variants), PermissionFooter, elapsed time, auto-collapse, tool error display |
