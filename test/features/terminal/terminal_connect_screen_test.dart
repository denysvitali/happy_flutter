...
extension _L10nX on BuildContext {
  _TestAppLocalizations get l10n =>
      Localizations.of<_TestAppLocalizations>(
        this,
        _TestAppLocalizations,
      ) ??
      const _TestAppLocalizations();
}
...
class _TestTerminalConnectScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(context.l10n.terminalConnect),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (_connectCalled) ...[
                ...
                Text('CONNECTED:$_connectMachineId:'
                    '$_connectTerminalId'),
              ],
            ],
          ),
...
void main() {
  ...
  group('TerminalConnectScreen', () {
    testWidgets(
      'renders app bar with connect title',
      (tester) async {
    ...
    testWidgets('renders info card with terminal icon',
        (tester) async {
      await tester.pumpWidget(
        _buildApp(
          child: const _TestTerminalConnectScreen(),
    ...
    testWidgets('shows no-machines message when list is empty',
        (tester) async {
      await tester.pumpWidget(
        _buildApp(
          child: const _TestTerminalConnectScreen(),
    ...
    testWidgets('connect button is disabled when no machines',
        (tester) async {
      await tester.pumpWidget(
        _buildApp(
          child: const _TestTerminalConnectScreen(),
    ...
    testWidgets('shows dropdown when machines exist',
        (tester) async {
      final machines = {
        'm1': _makeMachine(
          id: 'm1',
    ...
    testWidgets('connect button is enabled when machines exist',
        (tester) async {
      final machines = {
        'm1': _makeMachine(id: 'm1', displayName: 'Dev Box'),
      };
    ...
    testWidgets('can select a machine from dropdown',
        (tester) async {
      final machines = {
    ...
    testWidgets('shows terminal ID input field',
        (tester) async {
      await tester.pumpWidget(
        _buildApp(
          child: const _TestTerminalConnectScreen(),
      ...
      expect(
        find.text('e.g. main, dev, 1234'),
        findsOneWidget,
      );
    });

    testWidgets('can type in terminal ID field',
        (tester) async {
      await tester.pumpWidget(
        _buildApp(
          child: const _TestTerminalConnectScreen(),
    ...
    testWidgets(
      'form validation shows error when machine not selected',
      (tester) async {
        final machines = {
          'm1': _makeMachine(id: 'm1', displayName: 'Box'),
        };
        ...
        expect(
          find.text('Please select a machine'),
          findsOneWidget,
        );
      },
    );
    ...
    testWidgets(
      'form validation shows error when terminal ID empty',
      (tester) async {
        final machines = {
          'm1': _makeMachine(id: 'm1', displayName: 'Box'),
        };
    ...
    testWidgets(
      'successful connect populates connection details',
      (tester) async {
        final machines = {
          'm1': _makeMachine(id: 'm1', displayName: 'Laptop'),
        };
        ...
        expect(
          find.text('CONNECTED:m1:dev-session'),
          findsOneWidget,
        );
      },
    );

    testWidgets('renders machine label using host as fallback',
        (tester) async {
      final machines = {
        'm1': _makeMachine(
          id: 'm1',
