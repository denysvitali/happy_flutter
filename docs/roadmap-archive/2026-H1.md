# Roadmap archive — historical audits

Moved from `ROADMAP.md` on 2026-09-16 to keep the agent-inlined context small.
These dated audit narratives are history: they record what was found and fixed
in 2026-04 → 2026-09. For current state see `ROADMAP.md` (live priorities, P0
invariant status, Production Bugs / Performance trackers) and git history for
the fixes referenced here.
