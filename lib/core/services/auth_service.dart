...
class AuthService {
  ...
  Future<void> createAccount() async {
    ...
    try {
      ...
      if (e.type == DioExceptionType.connectionError ||
        ...
        if (statusCode != null && statusCode >= 500) {
          throw ServerError(errorMsg, statusCode: statusCode);
    ...
    if (response.statusCode == 200) {
      ...
      throw AuthRequestError('Account already exists', statusCode: 409);
    } else if (response.statusCode != null && response.statusCode! >= 500) {
      final errorMsg = _extractErrorMessage(response.data);
      throw ServerError(errorMsg, statusCode: response.statusCode);
