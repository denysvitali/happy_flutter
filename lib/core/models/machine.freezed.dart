...
@useResult
$Res call({
@JsonKey(fromJson: _asApiStringNullable) String? host,@JsonKey(fromJson: _asApiStringNullable) String? platform,@JsonKey(fromJson: _asApiStringNullable) String? happyCliVersion,@JsonKey(fromJson: _asApiStringNullable) String? happyHomeDir,@JsonKey(fromJson: _asApiStringNullable) String? homeDir,@JsonKey(fromJson: _asApiStringNullable) String? username,@JsonKey(fromJson: _asApiStringNullable) String? arch,@JsonKey(fromJson: _asApiStringNullable) String? displayName,@JsonKey(fromJson: _asApiStringNullable) String? daemonLastKnownStatus,@JsonKey(fromJson: _asApiIntNullable) int? daemonLastKnownPid,@JsonKey(fromJson: _asApiIntNullable) int? shutdownRequestedAt,@JsonKey(fromJson: _asApiStringNullable) String? shutdownSource,@JsonKey(fromJson: _stringListOrNull) List<String>? spawnBackends,@JsonKey(fromJson: _asApiStringNullable) String? defaultSpawnBackend,@JsonKey(fromJson: _asApiStringNullable) String? kubernetesCheckoutBaseDir,@JsonKey(fromJson: _asApiStringNullable) String? sandboxBackend,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxAvailable,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxEnabled,@JsonKey(fromJson: _asApiStringNullable) String? sandboxReason
});
...
as String?,kubernetesCheckoutBaseDir: freezed == kubernetesCheckoutBaseDir ? _self.kubernetesCheckoutBaseDir : kubernetesCheckoutBaseDir // ignore: cast_nullable_to_non_nullable
as String?,sandboxBackend: freezed == sandboxBackend ? _self.sandboxBackend : sandboxBackend // ignore: cast_nullable_to_non_nullable
as String?,sandboxAvailable: freezed == sandboxAvailable ? _self.sandboxAvailable : sandboxAvailable // ignore: cast_nullable_to_non_nullable
as bool?,sandboxEnabled: freezed == sandboxEnabled ? _self.sandboxEnabled : sandboxEnabled // ignore: cast_nullable_to_non_nullable
as bool?,sandboxReason: freezed == sandboxReason ? _self.sandboxReason : sandboxReason // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _asApiStringNullable)  String? host, @JsonKey(fromJson: _asApiStringNullable)  String? platform, @JsonKey(fromJson: _asApiStringNullable)  String? happyCliVersion, @JsonKey(fromJson: _asApiStringNullable)  String? happyHomeDir, @JsonKey(fromJson: _asApiStringNullable)  String? homeDir, @JsonKey(fromJson: _asApiStringNullable)  String? username, @JsonKey(fromJson: _asApiStringNullable)  String? arch, @JsonKey(fromJson: _asApiStringNullable)  String? displayName, @JsonKey(fromJson: _asApiStringNullable)  String? daemonLastKnownStatus, @JsonKey(fromJson: _asApiIntNullable)  int? daemonLastKnownPid, @JsonKey(fromJson: _asApiIntNullable)  int? shutdownRequestedAt, @JsonKey(fromJson: _asApiStringNullable)  String? shutdownSource, @JsonKey(fromJson: _stringListOrNull)  List<String>? spawnBackends, @JsonKey(fromJson: _asApiStringNullable)  String? defaultSpawnBackend, @JsonKey(fromJson: _asApiStringNullable)  String? kubernetesCheckoutBaseDir, @JsonKey(fromJson: _asApiStringNullable)  String? sandboxBackend, @JsonKey(fromJson: _asApiBoolNullable)  bool? sandboxAvailable, @JsonKey(fromJson: _asApiBoolNullable)  bool? sandboxEnabled, @JsonKey(fromJson: _asApiStringNullable)  String? sandboxReason)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MachineMetadata() when $default != null:
return $default(_that.host,_that.platform,_that.happyCliVersion,_that.happyHomeDir,_that.homeDir,_that.username,_that.arch,_that.displayName,_that.daemonLastKnownStatus,_that.daemonLastKnownPid,_that.shutdownRequestedAt,_that.shutdownSource,_that.spawnBackends,_that.defaultSpawnBackend,_that.kubernetesCheckoutBaseDir,_that.sandboxBackend,_that.sandboxAvailable,_that.sandboxEnabled,_that.sandboxReason);case _:
  return orElse();
...
class _MachineMetadata implements MachineMetadata {
  const _MachineMetadata({@JsonKey(fromJson: _asApiStringNullable) this.host, @JsonKey(fromJson: _asApiStringNullable) this.platform, @JsonKey(fromJson: _asApiStringNullable) this.happyCliVersion, @JsonKey(fromJson: _asApiStringNullable) this.happyHomeDir, @JsonKey(fromJson: _asApiStringNullable) this.homeDir, @JsonKey(fromJson: _asApiStringNullable) this.username, @JsonKey(fromJson: _asApiStringNullable) this.arch, @JsonKey(fromJson: _asApiStringNullable) this.displayName, @JsonKey(fromJson: _asApiStringNullable) this.daemonLastKnownStatus, @JsonKey(fromJson: _asApiIntNullable) this.daemonLastKnownPid, @JsonKey(fromJson: _asApiIntNullable) this.shutdownRequestedAt, @JsonKey(fromJson: _asApiStringNullable) this.shutdownSource, @JsonKey(fromJson: _stringListOrNull) final  List<String>? spawnBackends, @JsonKey(fromJson: _asApiStringNullable) this.defaultSpawnBackend, @JsonKey(fromJson: _asApiStringNullable) this.kubernetesCheckoutBaseDir, @JsonKey(fromJson: _asApiStringNullable) this.sandboxBackend, @JsonKey(fromJson: _asApiBoolNullable) this.sandboxAvailable, @JsonKey(fromJson: _asApiBoolNullable) this.sandboxEnabled, @JsonKey(fromJson: _asApiStringNullable) this.sandboxReason}): _spawnBackends = spawnBackends;
...
@override@JsonKey(fromJson: _asApiStringNullable) final  String? kubernetesCheckoutBaseDir;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? sandboxBackend;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? sandboxAvailable;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? sandboxEnabled;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,host,platform,happyCliVersion,happyHomeDir,homeDir,username,arch,displayName,daemonLastKnownStatus,daemonLastKnownPid,shutdownRequestedAt,shutdownSource,const DeepCollectionEquality().hash(_spawnBackends),defaultSpawnBackend,kubernetesCheckoutBaseDir,sandboxBackend,sandboxAvailable,sandboxEnabled,sandboxReason]);
