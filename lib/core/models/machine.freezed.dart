...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,host,platform,happyCliVersion,happyHomeDir,homeDir,username,arch,displayName,daemonLastKnownStatus,daemonLastKnownPid,shutdownRequestedAt,shutdownSource,const DeepCollectionEquality().hash(spawnBackends),defaultSpawnBackend,sandboxBackend,sandboxAvailable,sandboxEnabled,sandboxReason);

@override
String toString() {
  return 'MachineMetadata(host: $host, platform: $platform, happyCliVersion: $happyCliVersion, happyHomeDir: $happyHomeDir, homeDir: $homeDir, username: $username, arch: $arch, displayName: $displayName, daemonLastKnownStatus: $daemonLastKnownStatus, daemonLastKnownPid: $daemonLastKnownPid, shutdownRequestedAt: $shutdownRequestedAt, shutdownSource: $shutdownSource, spawnBackends: $spawnBackends, defaultSpawnBackend: $defaultSpawnBackend, sandboxBackend: $sandboxBackend, sandboxAvailable: $sandboxAvailable, sandboxEnabled: $sandboxEnabled, sandboxReason: $sandboxReason)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _asApiStringNullable) String? host,@JsonKey(fromJson: _asApiStringNullable) String? platform,@JsonKey(fromJson: _asApiStringNullable) String? happyCliVersion,@JsonKey(fromJson: _asApiStringNullable) String? happyHomeDir,@JsonKey(fromJson: _asApiStringNullable) String? homeDir,@JsonKey(fromJson: _asApiStringNullable) String? username,@JsonKey(fromJson: _asApiStringNullable) String? arch,@JsonKey(fromJson: _asApiStringNullable) String? displayName,@JsonKey(fromJson: _asApiStringNullable) String? daemonLastKnownStatus,@JsonKey(fromJson: _asApiIntNullable) int? daemonLastKnownPid,@JsonKey(fromJson: _asApiIntNullable) int? shutdownRequestedAt,@JsonKey(fromJson: _asApiStringNullable) String? shutdownSource,@JsonKey(fromJson: _stringListOrNull) List<String>? spawnBackends,@JsonKey(fromJson: _asApiStringNullable) String? defaultSpawnBackend,@JsonKey(fromJson: _asApiStringNullable) String? sandboxBackend,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxAvailable,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxEnabled,@JsonKey(fromJson: _asApiStringNullable) String? sandboxReason
});
...
switch (_that) {
case _MachineMetadata() when $default != null:
return $default(_that.host,_that.platform,_that.happyCliVersion,_that.happyHomeDir,_that.homeDir,_that.username,_that.arch,_that.displayName,_that.daemonLastKnownStatus,_that.daemonLastKnownPid,_that.shutdownRequestedAt,_that.shutdownSource,_that.spawnBackends,_that.defaultSpawnBackend,_that.sandboxBackend,_that.sandboxAvailable,_that.sandboxEnabled,_that.sandboxReason);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,host,platform,happyCliVersion,happyHomeDir,homeDir,username,arch,displayName,daemonLastKnownStatus,daemonLastKnownPid,shutdownRequestedAt,shutdownSource,const DeepCollectionEquality().hash(_spawnBackends),defaultSpawnBackend,sandboxBackend,sandboxAvailable,sandboxEnabled,sandboxReason);
