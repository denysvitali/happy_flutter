...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,path,host,version,name,os,summary,machineId,claudeSessionId,const DeepCollectionEquality().hash(tools),const DeepCollectionEquality().hash(slashCommands),homeDir,happyHomeDir,hostPid,flavor,lifecycleState,lifecycleStateError,lifecycleStateSince,repoUrl,repoRef,repoCommit,runtimeKind,podName,namespace,sandboxEnabled,sandboxRequested,sandboxRequired,sandboxEnforced,sandboxBackend,sandboxReason]);

@override
String toString() {
  return 'Metadata(path: $path, host: $host, version: $version, name: $name, os: $os, summary: $summary, machineId: $machineId, claudeSessionId: $claudeSessionId, tools: $tools, slashCommands: $slashCommands, homeDir: $homeDir, happyHomeDir: $happyHomeDir, hostPid: $hostPid, flavor: $flavor, lifecycleState: $lifecycleState, lifecycleStateError: $lifecycleStateError, lifecycleStateSince: $lifecycleStateSince, repoUrl: $repoUrl, repoRef: $repoRef, repoCommit: $repoCommit, runtimeKind: $runtimeKind, podName: $podName, namespace: $namespace, sandboxEnabled: $sandboxEnabled, sandboxRequested: $sandboxRequested, sandboxRequired: $sandboxRequired, sandboxEnforced: $sandboxEnforced, sandboxBackend: $sandboxBackend, sandboxReason: $sandboxReason)';
}
...
as String?,sandboxEnabled: freezed == sandboxEnabled ? _self.sandboxEnabled : sandboxEnabled // ignore: cast_nullable_to_non_nullable
