...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,seq,createdAt,updatedAt,active,activeAt,metadataVersion,agentStateVersion,thinking,archived,metadata,agentState,thinkingAt,presence,const DeepCollectionEquality().hash(todos),draft,permissionMode,modelMode,latestUsage,lastSeq,lastMessageAt,pinned,folder]);

@override
String toString() {
  return 'Session(id: $id, seq: $seq, createdAt: $createdAt, updatedAt: $updatedAt, active: $active, activeAt: $activeAt, metadataVersion: $metadataVersion, agentStateVersion: $agentStateVersion, thinking: $thinking, archived: $archived, metadata: $metadata, agentState: $agentState, thinkingAt: $thinkingAt, presence: $presence, todos: $todos, draft: $draft, permissionMode: $permissionMode, modelMode: $modelMode, latestUsage: $latestUsage, lastSeq: $lastSeq, lastMessageAt: $lastMessageAt, pinned: $pinned, folder: $folder)';
}
...
/// Create a copy of Session
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? seq = null,Object? createdAt = null,Object? updatedAt = null,Object? active = null,Object? activeAt = null,Object? metadataVersion = null,Object? agentStateVersion = null,Object? thinking = null,Object? archived = null,Object? metadata = freezed,Object? agentState = freezed,Object? thinkingAt = freezed,Object? presence = null,Object? todos = freezed,Object? draft = freezed,Object? permissionMode = freezed,Object? modelMode = freezed,Object? latestUsage = freezed,Object? lastSeq = freezed,Object? lastMessageAt = freezed,Object? pinned = null,Object? folder = freezed,}) {
  return _then(_self.copyWith(
...
switch (_that) {
case _Session() when $default != null:
return $default(_that.id,_that.seq,_that.createdAt,_that.updatedAt,_that.active,_that.activeAt,_that.metadataVersion,_that.agentStateVersion,_that.thinking,_that.archived,_that.metadata,_that.agentState,_that.thinkingAt,_that.presence,_that.todos,_that.draft,_that.permissionMode,_that.modelMode,_that.latestUsage,_that.lastSeq,_that.lastMessageAt,_that.pinned,_that.folder);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,seq,createdAt,updatedAt,active,activeAt,metadataVersion,agentStateVersion,thinking,archived,metadata,agentState,thinkingAt,presence,const DeepCollectionEquality().hash(_todos),draft,permissionMode,modelMode,latestUsage,lastSeq,lastMessageAt,pinned,folder]);
