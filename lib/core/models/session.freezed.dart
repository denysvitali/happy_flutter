...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,path,host,version,name,os,summary,machineId,claudeSessionId,const DeepCollectionEquality().hash(tools),const DeepCollectionEquality().hash(slashCommands),homeDir,happyHomeDir,hostPid,flavor,lifecycleState,lifecycleStateError,lifecycleStateSince,repoUrl,repoRef,repoCommit,sandboxEnabled]);

@override
String toString() {
  return 'Metadata(path: $path, host: $host, version: $version, name: $name, os: $os, summary: $summary, machineId: $machineId, claudeSessionId: $claudeSessionId, tools: $tools, slashCommands: $slashCommands, homeDir: $homeDir, happyHomeDir: $happyHomeDir, hostPid: $hostPid, flavor: $flavor, lifecycleState: $lifecycleState, lifecycleStateError: $lifecycleStateError, lifecycleStateSince: $lifecycleStateSince, repoUrl: $repoUrl, repoRef: $repoRef, repoCommit: $repoCommit, sandboxEnabled: $sandboxEnabled)';
}
...
/// Create a copy of Metadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? path = freezed,Object? host = null,Object? version = freezed,Object? name = freezed,Object? os = freezed,Object? summary = freezed,Object? machineId = freezed,Object? claudeSessionId = freezed,Object? tools = freezed,Object? slashCommands = freezed,Object? homeDir = freezed,Object? happyHomeDir = freezed,Object? hostPid = freezed,Object? flavor = freezed,Object? lifecycleState = freezed,Object? lifecycleStateError = freezed,Object? lifecycleStateSince = freezed,Object? repoUrl = freezed,Object? repoRef = freezed,Object? repoCommit = freezed,Object? sandboxEnabled = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _asApiStringNullable)  String? path,  String host, @JsonKey(fromJson: _asApiStringNullable)  String? version, @JsonKey(fromJson: _asApiStringNullable)  String? name, @JsonKey(fromJson: _asApiStringNullable)  String? os, @JsonKey(fromJson: _summaryFromJson)  Summary? summary, @JsonKey(fromJson: _asApiStringNullable)  String? machineId, @JsonKey(fromJson: _asApiStringNullable)  String? claudeSessionId, @JsonKey(fromJson: _asApiStringListNullable)  List<String>? tools, @JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable)  List<String>? slashCommands, @JsonKey(fromJson: _asApiStringNullable)  String? homeDir, @JsonKey(fromJson: _asApiStringNullable)  String? happyHomeDir, @JsonKey(fromJson: _asApiIntNullable)  int? hostPid, @JsonKey(fromJson: _asApiStringNullable)  String? flavor, @JsonKey(fromJson: _asApiStringNullable)  String? lifecycleState, @JsonKey(fromJson: _asApiStringNullable)  String? lifecycleStateError, @JsonKey(fromJson: _asApiIntNullable)  int? lifecycleStateSince, @JsonKey(fromJson: _asApiStringNullable)  String? repoUrl, @JsonKey(fromJson: _asApiStringNullable)  String? repoRef, @JsonKey(fromJson: _asApiStringNullable)  String? repoCommit, @JsonKey(name: 'sandbox', fromJson: _sandboxEnabledFromJson, toJson: _sandboxEnabledToJson)  bool? sandboxEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Metadata() when $default != null:
return $default(_that.path,_that.host,_that.version,_that.name,_that.os,_that.summary,_that.machineId,_that.claudeSessionId,_that.tools,_that.slashCommands,_that.homeDir,_that.happyHomeDir,_that.hostPid,_that.flavor,_that.lifecycleState,_that.lifecycleStateError,_that.lifecycleStateSince,_that.repoUrl,_that.repoRef,_that.repoCommit,_that.sandboxEnabled);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _asApiStringNullable)  String? path,  String host, @JsonKey(fromJson: _asApiStringNullable)  String? version, @JsonKey(fromJson: _asApiStringNullable)  String? name, @JsonKey(fromJson: _asApiStringNullable)  String? os, @JsonKey(fromJson: _summaryFromJson)  Summary? summary, @JsonKey(fromJson: _asApiStringNullable)  String? machineId, @JsonKey(fromJson: _asApiStringNullable)  String? claudeSessionId, @JsonKey(fromJson: _asApiStringListNullable)  List<String>? tools, @JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable)  List<String>? slashCommands, @JsonKey(fromJson: _asApiStringNullable)  String? homeDir, @JsonKey(fromJson: _asApiStringNullable)  String? happyHomeDir, @JsonKey(fromJson: _asApiIntNullable)  int? hostPid, @JsonKey(fromJson: _asApiStringNullable)  String? flavor, @JsonKey(fromJson: _asApiStringNullable)  String? lifecycleState, @JsonKey(fromJson: _asApiStringNullable)  String? lifecycleStateError, @JsonKey(fromJson: _asApiIntNullable)  int? lifecycleStateSince, @JsonKey(fromJson: _asApiStringNullable)  String? repoUrl, @JsonKey(fromJson: _asApiStringNullable)  String? repoRef, @JsonKey(fromJson: _asApiStringNullable)  String? repoCommit, @JsonKey(name: 'sandbox', fromJson: _sandboxEnabledFromJson, toJson: _sandboxEnabledToJson)  bool? sandboxEnabled)  $default,) {final _that = this;
switch (_that) {
case _Metadata():
return $default(_that.path,_that.host,_that.version,_that.name,_that.os,_that.summary,_that.machineId,_that.claudeSessionId,_that.tools,_that.slashCommands,_that.homeDir,_that.happyHomeDir,_that.hostPid,_that.flavor,_that.lifecycleState,_that.lifecycleStateError,_that.lifecycleStateSince,_that.repoUrl,_that.repoRef,_that.repoCommit,_that.sandboxEnabled);case _:
  throw StateError('Unexpected subclass');
