...
@JsonKey(fromJson: _asApiStringNullable) String? get path; String get host;@JsonKey(fromJson: _asApiStringNullable) String? get version;@JsonKey(fromJson: _asApiStringNullable) String? get name;@JsonKey(fromJson: _asApiStringNullable) String? get os;@JsonKey(fromJson: _summaryFromJson) Summary? get summary;@JsonKey(fromJson: _asApiStringNullable) String? get machineId;@JsonKey(fromJson: _asApiStringNullable) String? get claudeSessionId;@JsonKey(fromJson: _asApiStringListNullable) List<String>? get tools;@JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable) List<String>? get slashCommands;@JsonKey(fromJson: _asApiStringNullable) String? get homeDir;@JsonKey(fromJson: _asApiStringNullable) String? get happyHomeDir;@JsonKey(fromJson: _asApiIntNullable) int? get hostPid;@JsonKey(fromJson: _asApiStringNullable) String? get flavor;@JsonKey(fromJson: _asApiStringNullable) String? get model;@JsonKey(fromJson: _asApiStringNullable) String? get lifecycleState;@JsonKey(fromJson: _asApiStringNullable) String? get lifecycleStateError;@JsonKey(fromJson: _asApiIntNullable) int? get lifecycleStateSince;@JsonKey(fromJson: _asApiStringNullable) String? get repoUrl;@JsonKey(fromJson: _asApiStringNullable) String? get repoRef;@JsonKey(fromJson: _asApiStringNullable) String? get repoCommit;@JsonKey(name: 'runtimeType', fromJson: _asApiStringNullable) String? get runtimeKind;@JsonKey(fromJson: _asApiStringNullable) String? get podName;@JsonKey(fromJson: _asApiStringNullable) String? get namespace;@JsonKey(fromJson: _asApiStringNullable) String? get podPhase;@JsonKey(fromJson: _asApiStringNullable) String? get podStatus;@JsonKey(fromJson: _asApiBoolNullable) bool? get podReady;@JsonKey(fromJson: _asApiBoolNullable) bool? get podPaused;// sandbox field is stored as {enabled: bool} but we keep bool? in model
@JsonKey(name: 'sandbox', fromJson: _sandboxEnabledFromJson, toJson: _sandboxEnabledToJson) bool? get sandboxEnabled;@JsonKey(fromJson: _asApiBoolNullable) bool? get sandboxRequested;@JsonKey(fromJson: _asApiBoolNullable) bool? get sandboxRequired;@JsonKey(fromJson: _asApiBoolNullable) bool? get sandboxEnforced;@JsonKey(fromJson: _asApiStringNullable) String? get sandboxBackend;@JsonKey(fromJson: _asApiStringNullable) String? get sandboxReason; bool get resumeOnDaemonStart;@JsonKey(fromJson: _asApiStringNullable) String? get resumeOnDaemonStartMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Metadata&&(identical(other.path, path) || other.path == path)&&(identical(other.host, host) || other.host == host)&&(identical(other.version, version) || other.version == version)&&(identical(other.name, name) || other.name == name)&&(identical(other.os, os) || other.os == os)&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.machineId, machineId) || other.machineId == machineId)&&(identical(other.claudeSessionId, claudeSessionId) || other.claudeSessionId == claudeSessionId)&&const DeepCollectionEquality().equals(other.tools, tools)&&const DeepCollectionEquality().equals(other.slashCommands, slashCommands)&&(identical(other.homeDir, homeDir) || other.homeDir == homeDir)&&(identical(other.happyHomeDir, happyHomeDir) || other.happyHomeDir == happyHomeDir)&&(identical(other.hostPid, hostPid) || other.hostPid == hostPid)&&(identical(other.flavor, flavor) || other.flavor == flavor)&&(identical(other.model, model) || other.model == model)&&(identical(other.lifecycleState, lifecycleState) || other.lifecycleState == lifecycleState)&&(identical(other.lifecycleStateError, lifecycleStateError) || other.lifecycleStateError == lifecycleStateError)&&(identical(other.lifecycleStateSince, lifecycleStateSince) || other.lifecycleStateSince == lifecycleStateSince)&&(identical(other.repoUrl, repoUrl) || other.repoUrl == repoUrl)&&(identical(other.repoRef, repoRef) || other.repoRef == repoRef)&&(identical(other.repoCommit, repoCommit) || other.repoCommit == repoCommit)&&(identical(other.runtimeKind, runtimeKind) || other.runtimeKind == runtimeKind)&&(identical(other.podName, podName) || other.podName == podName)&&(identical(other.namespace, namespace) || other.namespace == namespace)&&(identical(other.podPhase, podPhase) || other.podPhase == podPhase)&&(identical(other.podStatus, podStatus) || other.podStatus == podStatus)&&(identical(other.podReady, podReady) || other.podReady == podReady)&&(identical(other.podPaused, podPaused) || other.podPaused == podPaused)&&(identical(other.sandboxEnabled, sandboxEnabled) || other.sandboxEnabled == sandboxEnabled)&&(identical(other.sandboxRequested, sandboxRequested) || other.sandboxRequested == sandboxRequested)&&(identical(other.sandboxRequired, sandboxRequired) || other.sandboxRequired == sandboxRequired)&&(identical(other.sandboxEnforced, sandboxEnforced) || other.sandboxEnforced == sandboxEnforced)&&(identical(other.sandboxBackend, sandboxBackend) || other.sandboxBackend == sandboxBackend)&&(identical(other.sandboxReason, sandboxReason) || other.sandboxReason == sandboxReason)&&(identical(other.resumeOnDaemonStart, resumeOnDaemonStart) || other.resumeOnDaemonStart == resumeOnDaemonStart)&&(identical(other.resumeOnDaemonStartMessage, resumeOnDaemonStartMessage) || other.resumeOnDaemonStartMessage == resumeOnDaemonStartMessage));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,path,host,version,name,os,summary,machineId,claudeSessionId,const DeepCollectionEquality().hash(tools),const DeepCollectionEquality().hash(slashCommands),homeDir,happyHomeDir,hostPid,flavor,model,lifecycleState,lifecycleStateError,lifecycleStateSince,repoUrl,repoRef,repoCommit,runtimeKind,podName,namespace,podPhase,podStatus,podReady,podPaused,sandboxEnabled,sandboxRequested,sandboxRequired,sandboxEnforced,sandboxBackend,sandboxReason,resumeOnDaemonStart,resumeOnDaemonStartMessage]);

@override
String toString() {
  return 'Metadata(path: $path, host: $host, version: $version, name: $name, os: $os, summary: $summary, machineId: $machineId, claudeSessionId: $claudeSessionId, tools: $tools, slashCommands: $slashCommands, homeDir: $homeDir, happyHomeDir: $happyHomeDir, hostPid: $hostPid, flavor: $flavor, model: $model, lifecycleState: $lifecycleState, lifecycleStateError: $lifecycleStateError, lifecycleStateSince: $lifecycleStateSince, repoUrl: $repoUrl, repoRef: $repoRef, repoCommit: $repoCommit, runtimeKind: $runtimeKind, podName: $podName, namespace: $namespace, podPhase: $podPhase, podStatus: $podStatus, podReady: $podReady, podPaused: $podPaused, sandboxEnabled: $sandboxEnabled, sandboxRequested: $sandboxRequested, sandboxRequired: $sandboxRequired, sandboxEnforced: $sandboxEnforced, sandboxBackend: $sandboxBackend, sandboxReason: $sandboxReason, resumeOnDaemonStart: $resumeOnDaemonStart, resumeOnDaemonStartMessage: $resumeOnDaemonStartMessage)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: _asApiStringNullable) String? path, String host,@JsonKey(fromJson: _asApiStringNullable) String? version,@JsonKey(fromJson: _asApiStringNullable) String? name,@JsonKey(fromJson: _asApiStringNullable) String? os,@JsonKey(fromJson: _summaryFromJson) Summary? summary,@JsonKey(fromJson: _asApiStringNullable) String? machineId,@JsonKey(fromJson: _asApiStringNullable) String? claudeSessionId,@JsonKey(fromJson: _asApiStringListNullable) List<String>? tools,@JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable) List<String>? slashCommands,@JsonKey(fromJson: _asApiStringNullable) String? homeDir,@JsonKey(fromJson: _asApiStringNullable) String? happyHomeDir,@JsonKey(fromJson: _asApiIntNullable) int? hostPid,@JsonKey(fromJson: _asApiStringNullable) String? flavor,@JsonKey(fromJson: _asApiStringNullable) String? model,@JsonKey(fromJson: _asApiStringNullable) String? lifecycleState,@JsonKey(fromJson: _asApiStringNullable) String? lifecycleStateError,@JsonKey(fromJson: _asApiIntNullable) int? lifecycleStateSince,@JsonKey(fromJson: _asApiStringNullable) String? repoUrl,@JsonKey(fromJson: _asApiStringNullable) String? repoRef,@JsonKey(fromJson: _asApiStringNullable) String? repoCommit,@JsonKey(name: 'runtimeType', fromJson: _asApiStringNullable) String? runtimeKind,@JsonKey(fromJson: _asApiStringNullable) String? podName,@JsonKey(fromJson: _asApiStringNullable) String? namespace,@JsonKey(fromJson: _asApiStringNullable) String? podPhase,@JsonKey(fromJson: _asApiStringNullable) String? podStatus,@JsonKey(fromJson: _asApiBoolNullable) bool? podReady,@JsonKey(fromJson: _asApiBoolNullable) bool? podPaused,@JsonKey(name: 'sandbox', fromJson: _sandboxEnabledFromJson, toJson: _sandboxEnabledToJson) bool? sandboxEnabled,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxRequested,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxRequired,@JsonKey(fromJson: _asApiBoolNullable) bool? sandboxEnforced,@JsonKey(fromJson: _asApiStringNullable) String? sandboxBackend,@JsonKey(fromJson: _asApiStringNullable) String? sandboxReason, bool resumeOnDaemonStart,@JsonKey(fromJson: _asApiStringNullable) String? resumeOnDaemonStartMessage
});
...
/// Create a copy of Metadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? path = freezed,Object? host = null,Object? version = freezed,Object? name = freezed,Object? os = freezed,Object? summary = freezed,Object? machineId = freezed,Object? claudeSessionId = freezed,Object? tools = freezed,Object? slashCommands = freezed,Object? homeDir = freezed,Object? happyHomeDir = freezed,Object? hostPid = freezed,Object? flavor = freezed,Object? model = freezed,Object? lifecycleState = freezed,Object? lifecycleStateError = freezed,Object? lifecycleStateSince = freezed,Object? repoUrl = freezed,Object? repoRef = freezed,Object? repoCommit = freezed,Object? runtimeKind = freezed,Object? podName = freezed,Object? namespace = freezed,Object? podPhase = freezed,Object? podStatus = freezed,Object? podReady = freezed,Object? podPaused = freezed,Object? sandboxEnabled = freezed,Object? sandboxRequested = freezed,Object? sandboxRequired = freezed,Object? sandboxEnforced = freezed,Object? sandboxBackend = freezed,Object? sandboxReason = freezed,Object? resumeOnDaemonStart = null,Object? resumeOnDaemonStartMessage = freezed,}) {
...
as int?,repoUrl: freezed == repoUrl ? _self.repoUrl : repoUrl // ignore: cast_nullable_to_non_nullable
as String?,repoRef: freezed == repoRef ? _self.repoRef : repoRef // ignore: cast_nullable_to_non_nullable
as String?,repoCommit: freezed == repoCommit ? _self.repoCommit : repoCommit // ignore: cast_nullable_to_non_nullable
as String?,runtimeKind: freezed == runtimeKind ? _self.runtimeKind : runtimeKind // ignore: cast_nullable_to_non_nullable
as String?,podName: freezed == podName ? _self.podName : podName // ignore: cast_nullable_to_non_nullable
as String?,namespace: freezed == namespace ? _self.namespace : namespace // ignore: cast_nullable_to_non_nullable
as String?,podPhase: freezed == podPhase ? _self.podPhase : podPhase // ignore: cast_nullable_to_non_nullable
as String?,podStatus: freezed == podStatus ? _self.podStatus : podStatus // ignore: cast_nullable_to_non_nullable
as String?,podReady: freezed == podReady ? _self.podReady : podReady // ignore: cast_nullable_to_non_nullable
as bool?,podPaused: freezed == podPaused ? _self.podPaused : podPaused // ignore: cast_nullable_to_non_nullable
as bool?,sandboxEnabled: freezed == sandboxEnabled ? _self.sandboxEnabled : sandboxEnabled // ignore: cast_nullable_to_non_nullable
as bool?,sandboxRequested: freezed == sandboxRequested ? _self.sandboxRequested : sandboxRequested // ignore: cast_nullable_to_non_nullable
as bool?,sandboxRequired: freezed == sandboxRequired ? _self.sandboxRequired : sandboxRequired // ignore: cast_nullable_to_non_nullable
as bool?,sandboxEnforced: freezed == sandboxEnforced ? _self.sandboxEnforced : sandboxEnforced // ignore: cast_nullable_to_non_nullable
as bool?,sandboxBackend: freezed == sandboxBackend ? _self.sandboxBackend : sandboxBackend // ignore: cast_nullable_to_non_nullable
as String?,sandboxReason: freezed == sandboxReason ? _self.sandboxReason : sandboxReason // ignore: cast_nullable_to_non_nullable
as String?,resumeOnDaemonStart: null == resumeOnDaemonStart ? _self.resumeOnDaemonStart : resumeOnDaemonStart // ignore: cast_nullable_to_non_nullable
as bool,resumeOnDaemonStartMessage: freezed == resumeOnDaemonStartMessage ? _self.resumeOnDaemonStartMessage : resumeOnDaemonStartMessage // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of Metadata
...
class _Metadata implements Metadata {
  const _Metadata({@JsonKey(fromJson: _asApiStringNullable) this.path, this.host = '', @JsonKey(fromJson: _asApiStringNullable) this.version, @JsonKey(fromJson: _asApiStringNullable) this.name, @JsonKey(fromJson: _asApiStringNullable) this.os, @JsonKey(fromJson: _summaryFromJson) this.summary, @JsonKey(fromJson: _asApiStringNullable) this.machineId, @JsonKey(fromJson: _asApiStringNullable) this.claudeSessionId, @JsonKey(fromJson: _asApiStringListNullable) final  List<String>? tools, @JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable) final  List<String>? slashCommands, @JsonKey(fromJson: _asApiStringNullable) this.homeDir, @JsonKey(fromJson: _asApiStringNullable) this.happyHomeDir, @JsonKey(fromJson: _asApiIntNullable) this.hostPid, @JsonKey(fromJson: _asApiStringNullable) this.flavor, @JsonKey(fromJson: _asApiStringNullable) this.model, @JsonKey(fromJson: _asApiStringNullable) this.lifecycleState, @JsonKey(fromJson: _asApiStringNullable) this.lifecycleStateError, @JsonKey(fromJson: _asApiIntNullable) this.lifecycleStateSince, @JsonKey(fromJson: _asApiStringNullable) this.repoUrl, @JsonKey(fromJson: _asApiStringNullable) this.repoRef, @JsonKey(fromJson: _asApiStringNullable) this.repoCommit, @JsonKey(name: 'runtimeType', fromJson: _asApiStringNullable) this.runtimeKind, @JsonKey(fromJson: _asApiStringNullable) this.podName, @JsonKey(fromJson: _asApiStringNullable) this.namespace, @JsonKey(fromJson: _asApiStringNullable) this.podPhase, @JsonKey(fromJson: _asApiStringNullable) this.podStatus, @JsonKey(fromJson: _asApiBoolNullable) this.podReady, @JsonKey(fromJson: _asApiBoolNullable) this.podPaused, @JsonKey(name: 'sandbox', fromJson: _sandboxEnabledFromJson, toJson: _sandboxEnabledToJson) this.sandboxEnabled, @JsonKey(fromJson: _asApiBoolNullable) this.sandboxRequested, @JsonKey(fromJson: _asApiBoolNullable) this.sandboxRequired, @JsonKey(fromJson: _asApiBoolNullable) this.sandboxEnforced, @JsonKey(fromJson: _asApiStringNullable) this.sandboxBackend, @JsonKey(fromJson: _asApiStringNullable) this.sandboxReason, this.resumeOnDaemonStart = false, @JsonKey(fromJson: _asApiStringNullable) this.resumeOnDaemonStartMessage}): _tools = tools,_slashCommands = slashCommands;
...
@override@JsonKey(readValue: _readSlashCommands, fromJson: _asApiStringListNullable) List<String>? get slashCommands {
...
@override@JsonKey(fromJson: _asApiStringNullable) final  String? model;
...
@override@JsonKey(fromJson: _asApiStringNullable) final  String? repoUrl;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? repoRef;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? repoCommit;
@override@JsonKey(name: 'runtimeType', fromJson: _asApiStringNullable) final  String? runtimeKind;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? podName;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? namespace;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? podPhase;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? podStatus;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? podReady;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? podPaused;
...
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? sandboxRequested;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? sandboxRequired;
@override@JsonKey(fromJson: _asApiBoolNullable) final  bool? sandboxEnforced;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? sandboxBackend;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? sandboxReason;
@override@JsonKey() final  bool resumeOnDaemonStart;
@override@JsonKey(fromJson: _asApiStringNullable) final  String? resumeOnDaemonStartMessage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,path,host,version,name,os,summary,machineId,claudeSessionId,const DeepCollectionEquality().hash(_tools),const DeepCollectionEquality().hash(_slashCommands),homeDir,happyHomeDir,hostPid,flavor,model,lifecycleState,lifecycleStateError,lifecycleStateSince,repoUrl,repoRef,repoCommit,runtimeKind,podName,namespace,podPhase,podStatus,podReady,podPaused,sandboxEnabled,sandboxRequested,sandboxRequired,sandboxEnforced,sandboxBackend,sandboxReason,resumeOnDaemonStart,resumeOnDaemonStartMessage]);
