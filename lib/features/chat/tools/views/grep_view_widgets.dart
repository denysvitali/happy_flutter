...
class GrepPatternBadge extends StatelessWidget {
  /// Creates a [GrepPatternBadge].
  const GrepPatternBadge({
...
class GrepPathChip extends StatelessWidget {
  /// Creates a [GrepPathChip].
  const GrepPathChip({required this.path, super.key});
