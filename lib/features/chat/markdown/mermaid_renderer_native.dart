/// Native (Android/iOS/desktop) mermaid diagram renderer using WebView.
///
/// This file is selected on non-web platforms via the conditional import
/// in mermaid_renderer.dart.
library;

import 'package:flutter/material.dart';
import 'package:webview_flutter/webview_flutter.dart';

/// A widget that renders Mermaid diagrams using an embedded WebView.
///
/// Uses webview_flutter for native platforms (Android, iOS, macOS, etc.).
/// The mermaid.js library is loaded from CDN inside the WebView.
...
<body>
    ...
    <script>
        (function() {
            ...
            mermaid.run({ nodes: ['.mermaid'] }).then(function() {
                ...
                container.innerHTML =
                  ...
                  + 'Mermaid diagram syntax error</div>';
                if (window.FlutterChannel) {
